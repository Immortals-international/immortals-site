...
export const layouts = [
  ...
  },
  {
    ...
    description: 'A discovery lounge brings demonstrations to the busy mall corner. A visible working lab opens onto the public promenade, which leads to the window café and glazed experience rooms, while four internal suites sit behind a separate clinical branch. Support moves beside the retained escape.',
  ...
  },
  {
    ...
    description: 'The left entrance opens into a social salon at the lower tip, beside a working lab visible from both the mall and the salon. A discovery route leads to the shared window living room. Patients retain their right-hand arrival and internal suite cluster; toilets and support move into the upper clinical core.',
  ...
  },
  {
    ...
    description: 'The bottom corner becomes a public forum for talks, demonstrations and small events. A glazed lab occupies the mall-facing triangle beside the public arrival. A hosted hall links both entrances, with a clear route around the internal support block to the window café and experience rooms. The private wing keeps its own share of the view.',
  ...
  },
  {
    ...
    description: 'A neighbourhood living room with coffee occupies the mall corner, with the salons opening onto it. The public spine continues to a window room with a visible working lab between two care houses. Each suite pair keeps its local lounge and preparation space; support sits inside the care spine.',
